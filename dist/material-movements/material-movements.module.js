...
let MaterialMovementsModule = class MaterialMovementsModule {
};
MaterialMovementsModule = __decorate([
    Module({
        imports: [AuthModule],
...
export { MaterialMovementsModule };
//# sourceMappingURL=material-movements.module.js.map